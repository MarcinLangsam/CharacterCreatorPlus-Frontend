...
export const modifiers: Modifiers = {
  strength : {
    ...
    //keys: ['melleThac0', 'dmgBonus', 'bashing', 'weight'],
  },
  ...
  agility: {
    ...
    //keys: ['rangedThac0', 'AC', 'Kradzież_KieszonkowaBonus', 'Otwieranie_ZamkówBonus', 'Znajdywanie_PułapekBonus', 'Ciche_PoruszanieBonus' , 'Krycie_W_CieniuBonus', 'Rozstawianie_Pułapek'],
  },
  ...
  constitution: {
    ...
    //keys: ['HPperLvBonus', 'IntoxicationPerDrink', 'fatigue'],
  },
  ...
  intelligence: {
    ...
    //keys: ['INTmaxSpellLevel', 'INTspellPerLevel', 'scribeSuccessRate' , 'INTlore'],
  },
  ...
  wisdom: {
    ...
    //keys: ['extraSpellSlotlv1', 'extraSpellSlotlv2', 'extraSpellSlotlv3' , 'extraSpellSlotlv4', 'WISlore'],
  },
